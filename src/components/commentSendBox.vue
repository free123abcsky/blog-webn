<template>
  <div class="com-sendbox">
    <div class="sendbox" :class="{'sendbox-active': conmentActive}">
      <div class="send-side">
        <div class="send-avatar set-userinfo"><img src="//dn-lay.qbox.me/build/single-page/images/default_9fa6849.jpg" onerror="L.gravatar_error_fn(this)"></div>
        <a href="javascript:void(0)" class="send-username set-userinfo" title="雁过留名">雁过留名</a>
      </div>
      <div class="sendbox-main">
        <div class="send-textarea">
          <textarea v-model="content" @blur.change="commenting" ref="cbox"></textarea>
          <div class="send-placeholder" @click="commenting">要说点什么嘛...</div>
        </div>
  ...
  export default{
    ...
    methods: {
      ...
      commenting: function() {
        ...
        if(!_this.conmentActive){
          _this.$refs.cbox.focus();
          _this.conmentActive = true;
        }else{
          _this.conmentActive = false;
        }
      },
      submit: function () {
