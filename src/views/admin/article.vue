<template>
  <div class="box-content">
    <h3 class="title">
      文章编辑 / <span class="blue">ARTICLE-EDIT</span>
    </h3>
    <section class="main-section">
              ...
              <div class="form-group imgUploadBox">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <icon :type="{true:'load-c',false:'ios-cloud-upload-outline'}[isImgLoading]"></icon>
                    <span class="fa fa-fw"
      ...
      <div class="preview-section" v-if="isShowBigAdmin">
        <div class="block">
