...
<template>
  <div class="blog-nav ">
    <nav class="nav-top">
      ...
      <!--<router-link class="nav-item " :to="{ name: 'blog'}" activeClass="active"-->
      <router-link class="nav-item " :to="{ name: 'blog'}" activeClass="active"
                   data-toggle="tooltip" data-placement="right" title="博客">
        <i class="fa fa-map-signs fa-fw fa-lg"></i>
      </router-link>
      <router-link class="nav-item " :to="{ name: 'music'}" data-toggle="tooltip" activeClass="active"
                   data-placement="right"
                   title="音乐">
    ...
    <nav class="nav-bottom">
      ...
      <router-link v-show="!isLogin" class="nav-item  hidden-xs" :to="{ name: 'login'}" activeClass="active"
